                              ...
                              <ul id="menu-menu-2" class="sf-menu sf-js-enabled">
                                 ...
                                 <li class="menu-item menu-item-type-custom menu-item-object-custom menu-item-has-children td-menu-item td-normal-menu menu-item-20931">
                                    ...
                                    <ul class="sub-menu" style="float: none; width: 16.8571em; display: none;">
                                       <li class="menu-item menu-item-type-post_type menu-item-object-page td-menu-item td-normal-menu menu-item-37962" style="white-space: normal; float: left; width: 100%;"><a href="https://www.techuntold.com/view-full-size-instagram-photos/" style="float: none; width: auto;">View Full Size Instagram Photos </a></li>
                                       <li class="menu-item menu-item-type-post_type menu-item-object-page td-menu-item td-normal-menu menu-item-7380" style="white-space: normal; float: left; width: 100%;"><a href="https://www.techuntold.com/how-download-igtv-videos/" style="float: none; width: auto;">How To Download IGTV Videos</a></li>
                                       <li class="menu-item menu-item-type-post_type menu-item-object-page td-menu-item td-normal-menu menu-item-7379" style="white-space: normal; float: left; width: 100%;"><a href="https://www.techuntold.com/instagram-tips-tricks/" style="float: none; width: auto;">Instagram Tips And Tricks</a></li>
                                    </ul>
                                 </li>
...
<ins class="adsbygoogle"
     style="display:block"
     data-ad-client="ca-pub-3543964375659775"
     data-ad-slot="9493616950"
     data-ad-format="auto"
