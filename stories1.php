               ...
               <div class="menu-menu-1-container">
                  <ul id="menu-menu-1" class="td-mobile-main-menu">
                    <li id="menu-item-20931" class="menu-item menu-item-type-custom menu-item-object-custom menu-item-has-children menu-item-20931 td_mobile_submenu td_mobile_elem_with_submenu_7">
                        ...
                        <ul class="sub-menu">
                           <li id="menu-item-37962" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-37962"><a href="https://www.techuntold.com/us/">Related  Articles 1 </a></li>
                           <li id="menu-item-7380" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-7380"><a href="https://www.techuntold.com/contact-us/">Related  Articles 2</a></li>
                           <li id="menu-item-7379" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-7379"><a href="https://www.techuntold.com/advertise-with-us/">Related  Articles 3</a></li>
                           <li id="menu-item-33512" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-privacy-policy menu-item-33512"><a href="https://www.techuntold.com/privacy-policy/">Related  Articles 4</a></li>
                        </ul>
                     </li>
                     <li id="menu-item-25887" class="menu-item menu-item-type-taxonomy menu-item-object-category menu-item-first menu-item-25887"><a href="https://www.techuntold.com/category/how-to/">Contact</a></li>
                        ...
                        <div id="td-header-menu" role="navigation">
                           ...
                           <div class="td-main-menu-logo td-logo-in-menu td-logo-sticky">
                    			...
                    			<img src="https://www.techuntold.com/wp-content/uploads/2018/09/techuntold-logo-for-mobile-1.png" alt="TechUntold Logo">
                    				...
                    				<a class="td-header-logo td-sticky-header" href="https://www.techuntold.com/">
                    				<img src="https://www.techuntold.com/wp-content/uploads/2018/09/techuntold-logo-with-Name.png" alt="TechUntold Logo">
                    				<span class="td-visual-hidden">TechUntold</span>
                    			</a>
                    		    </div>
                           </div>
                        ...
                        <div class="header-search-wrap">
                           <div class="menu-menu-1-container">
                              <ul id="menu-menu-2" class="sf-menu sf-js-enabled">
                                 ...
                                 <li class="menu-item menu-item-type-custom menu-item-object-custom menu-item-has-children td-menu-item td-normal-menu menu-item-20931">
                                    <a href="#" class="sf-with-ul">Related  Articles <i class="td-icon-menu-down"></i></a>
                                    <ul class="sub-menu" style="float: none; width: 16.8571em; display: none;">
                                       <li class="menu-item menu-item-type-post_type menu-item-object-page td-menu-item td-normal-menu menu-item-37962" style="white-space: normal; float: left; width: 100%;"><a href="https://www.techuntold.com/us/" style="float: none; width: auto;">Related  Articles 1 </a></li>
                                       <li class="menu-item menu-item-type-post_type menu-item-object-page td-menu-item td-normal-menu menu-item-7380" style="white-space: normal; float: left; width: 100%;"><a href="https://www.techuntold.com/contact-us/" style="float: none; width: auto;">Related  Articles 2</a></li>
                                       <li class="menu-item menu-item-type-post_type menu-item-object-page td-menu-item td-normal-menu menu-item-7379" style="white-space: normal; float: left; width: 100%;"><a href="https://www.techuntold.com/advertise-with-us/" style="float: none; width: auto;">Related  Articles 3</a></li>
                                       <li class="menu-item menu-item-type-post_type menu-item-object-page menu-item-privacy-policy td-menu-item td-normal-menu menu-item-33512" style="white-space: normal; float: left; width: 100%;"><a href="https://www.techuntold.com/privacy-policy/" style="float: none; width: auto;">Related  Articles 4</a></li>
                                    </ul>
                                 </li>
                                 <li class="menu-item menu-item-type-taxonomy menu-item-object-category menu-item-first td-menu-item td-normal-menu menu-item-25887"><a href="https://www.techuntold.com/category/how-to/">Contact</a></li>
                              </ul>
...
<div style="Display: flex; Align-items: center; justify-content: center; position: relative;width: 345px; margin: 0 auto;">
<a href="https://techuntold.com/storyhoot/" style=" position: absolute;
    left: 0;"><button type="button" class="btn" style="background-color: #aa1801; color: #fff; Justify-self : flex-start; ">Back</button></a>
                  ...
                  foreach($server_output->items as $row){
                    ...
                    if($row->media_type==1){
                      ...
                      echo '<div style="padding: 17px;">
                          ...
                          <div class="download">
                            <a download="myimage" href="'.$row->image_versions2->candidates[0]->url.'" target="_blank" rel="noopener noreferrer" class="">DOWNLOAD</a></div>
                      </div>';
                        ...
                        echo '<div style="padding: 17px;"><div align="center">
                          ...
                          <a download="myvideo" href="'.$row->video_versions[0]->url.'" target="_blank" rel="noopener noreferrer" class="">DOWNLOAD</a></div>
                          </div>';
